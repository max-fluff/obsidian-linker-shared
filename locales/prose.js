...
const ru = {
  ...
  'kind.term': 'Термин',
  'kind.viaAlias': 'по алиасу «{form}»',
  'set.smartCase.name': 'Умный регистр для аббревиатур',
  'set.smartCase.desc': 'Термины из заглавных букв (например «IT» или «NASA») сопоставляются с учётом регистра, чтобы не цеплять обычные слова.',
...
const de = {
  ...
  'set.suggestPlainText.name': 'Reinen Text einfügen',
  'set.suggestPlainText.desc': 'Vorschläge vervollständigen das Wort, ohne daraus einen Link zu machen.',
  ...
  'kind.term': 'Begriff',
  'kind.viaAlias': 'über Alias „{form}“',
  'set.smartCase.name': 'Schreibweise von Abkürzungen beachten',
  'set.smartCase.desc': 'Überwiegend großgeschriebene Begriffe (etwa „IT“ oder „NASA“) werden nur bei gleicher Schreibweise verknüpft, damit sie keine gewöhnlichen Wörter erfassen.',
...
const es = {
  ...
  'kind.term': 'Término',
  'kind.viaAlias': 'por el alias «{form}»',
  'set.smartCase.name': 'Distinguir mayúsculas en siglas',
  'set.smartCase.desc': 'Los términos escritos casi todo en mayúsculas (como «IT» o «NASA») solo coinciden con esa misma grafía, para que no enlacen palabras corrientes.',
...
const fr = {
  ...
  'set.suggestPlainText.name': 'Insérer du texte simple',
  'set.suggestPlainText.desc': 'Les suggestions complètent le mot sans en faire un lien.',
  ...
  'kind.heading': 'Titre',
  'kind.term': 'Terme',
  'kind.viaAlias': 'via l’alias « {form} »',
  'set.smartCase.name': 'Respecter la casse des sigles',
  'set.smartCase.desc': 'Les termes écrits en majuscules (comme « IT » ou « NASA ») ne correspondent qu’à la même graphie, afin de ne pas lier des mots ordinaires.',
...
const uk = {
  ...
  'kind.heading': 'Заголовок',
  'kind.term': 'Термін',
  'kind.viaAlias': 'за аліасом «{form}»',
  'set.smartCase.name': 'Розумний регістр для абревіатур',
  'set.smartCase.desc': 'Терміни з великих літер (наприклад «IT» або «NASA») зіставляються з урахуванням регістру, щоб не чіпляти звичайні слова.',
